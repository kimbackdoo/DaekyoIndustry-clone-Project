...
#GalleryUl > li { float:left; width:350px; height:235px; margin:100px 0 20px 75px; position:relative; }
...
.GU_con { float:left; width:100%; padding:10px 0; }
.GU_subj { width:100%; font-size:17px; color: #000; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:center; }
/*
.GU_subj {
